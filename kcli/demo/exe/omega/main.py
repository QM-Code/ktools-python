...
def main(argv: list[str] | None = None) -> int:
    ...
    build_parser.set_handler("-profile", _handle_build_profile, "Set build profile.")
    build_parser.set_handler("-clean", _handle_build_clean, "Enable clean build.")
    ...
    parser.add_alias("-b", "--build-profile")
    ...
    parser.set_positional_handler(_handle_args)
